    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary-600 via-primary-700 to-primary-900 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          ...
          <p className="text-lg text-primary-100 leading-relaxed max-w-md">
            Adaptive practice powered by AI. Master reading comprehension with personalized exercises tailored to your skill level.
          </p>
      ...
      <div className="flex-1 flex items-center justify-center bg-gray-50 p-6">
        <div className="w-full max-w-sm animate-fade-in">
          ...
          <p className="text-gray-500 mt-1.5 mb-8">Sign in to continue your preparation</p>
          ...
          <p className="text-center text-sm text-gray-400 mt-3">
            <Link href="/demo" className="text-violet-600 font-medium hover:text-violet-700 transition-colors">
              Try a sample question first
            </Link>
          </p>
        </div>
      </div>
